package com.example.ex_wanzhipeng001.demo_java.main;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_basis) {
            Intent intent = new Intent(this, BasisMainActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_views) {
            Intent intent = new Intent(this, ViewsMainActivity.class);
            startActivity(intent);
